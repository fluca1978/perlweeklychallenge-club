...
public class Task2 {
    ...
    @Function( schema = "pwc291",
	       ...
	       effects = IMMUTABLE )
    public static final void task2_pljava() throws SQLException {
	logger.log( Level.INFO, "Entering pwc291.task2_pljava" );
	throw new SQLException( "pwc291.task2_pljava() not yet implemented!" );
    }
}
